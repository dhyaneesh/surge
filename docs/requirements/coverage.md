...
- Supporting design capabilities: **6**
...
| `DESIGN-RUNTIME-001` | `docs/superpowers/specs/2026-07-23-minimal-guardian-runtime-design.md` §Store and service boundary | `implemented` | `apps/guardian_api/models.py`, `apps/guardian_api/store.py`, `apps/guardian_api/service.py`, `testbeds/scenarios/facts.py` | `tests/unit/test_guardian_service.py`, `tests/unit/test_scenario_facts.py` |
| `DESIGN-RUNTIME-002` | `docs/superpowers/specs/2026-07-23-minimal-guardian-runtime-design.md` §Store and service boundary | `implemented` | `apps/guardian_api/http.py`, `apps/guardian_api/__main__.py`, `apps/guardian_api/models.py`, `apps/guardian_api/service.py`, `apps/guardian_api/store.py`, `testbeds/scenarios/guardian_client.py`, `testbeds/scenarios/execution.py` | `tests/integration/test_guardian_http.py`, `tests/security/test_guardian_http_security.py`, `tests/unit/test_guardian_service.py`, `tests/unit/test_scenario_facts.py`, `tests/unit/test_guardian_scenario_client.py`, `tests/unit/test_scenario_execution.py`, `tests/integration/test_scenario_guardian_lifecycle.py`, `tests/security/test_scenario_guardian_security.py`, `tests/integration/test_legitimate_demand_scale_up.py` |
| `DESIGN-RUNTIME-003` | `docs/superpowers/specs/2026-07-23-minimal-guardian-runtime-design.md` §Independent testbed evidence collection | `implemented` | `testbeds/evidence/contracts.py`, `testbeds/evidence/collector.py`, `testbeds/evidence/signoz.py`, `testbeds/environments/capabilities.py`, `testbeds/scenarios/compatibility.py`, `testbeds/scenarios/evidence_provider.py`, `testbeds/scenarios/facts.py`, `testbeds/scenarios/execution.py`, `testbeds/scenarios/environment_suite.py`, `testbeds/scenarios/matrix.py` | `tests/unit/test_evidence_collector.py`, `tests/unit/test_evidence_provider.py`, `tests/unit/test_scenario_compatibility.py`, `tests/unit/test_scenario_catalog.py`, `tests/contract/test_environment_capability_declarations.py`, `tests/contract/test_scenario_execution_contract.py`, `tests/unit/test_scenario_facts.py`, `tests/unit/test_scenario_execution.py`, `tests/unit/test_scenario_matrix.py`, `tests/integration/test_scenario_guardian_lifecycle.py`, `tests/integration/test_legitimate_demand_scale_up.py`, `tests/integration/test_live_evidence_lifecycle.py`, `tests/unit/test_guardian_domain.py` |
