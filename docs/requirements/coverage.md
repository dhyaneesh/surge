...
| `DESIGN-RUNTIME-001` | `docs/superpowers/specs/2026-07-23-minimal-guardian-runtime-design.md` §Store and service boundary | `implemented` | `apps/guardian_api/store.py`, `apps/guardian_api/service.py` | `tests/unit/test_guardian_service.py` |
