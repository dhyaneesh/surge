...
| `DESIGN-RUNTIME-002` | `docs/superpowers/specs/2026-07-23-minimal-guardian-runtime-design.md` §Store and service boundary | `implemented` | `apps/guardian_api/http.py`, `apps/guardian_api/__main__.py` | `tests/integration/test_guardian_http.py`, `tests/security/test_guardian_http_security.py` |
